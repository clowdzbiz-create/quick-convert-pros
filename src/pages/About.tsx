    ...
    <main className="max-w-3xl mx-auto px-4 py-12 min-h-screen">
      ...
      <div className="prose prose-sm dark:prose-invert max-w-none space-y-6 text-foreground/90">
        <p className="text-lg leading-relaxed">
          Clowd Converter is a <strong>free online file converter</strong> built by Clowd Marketing. We believe file conversion should be fast, free, and private — so we built a tool that processes everything right in your browser.
        </p>
